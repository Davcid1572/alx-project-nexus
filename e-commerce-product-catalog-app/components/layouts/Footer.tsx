...
const Footer = () => {
  return (
    <>
      ...
      <footer className="px-6 md:px-16 lg:px-24 xl:px-32 w-full text-sm text-slate-500 border-t border-gray-300 bg-white pt-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-14">
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="text-sm/7 mt-6">
              ShopEase is your one-stop online shop for the latest and greatest.
          ...
          <div>
            ...
            <div className="text-sm space-y-6 max-w-sm">
              <p>
                Get the latest news, articles, and resources, about products
                sent to your inbox
              </p>
        ...
        <p className="py-4 text-center border-t mt-6 border-slate-200">
          Copyright 2026 © <a href="/">ShopEase</a> All Right Reserved.
        </p>
      </footer>
    </>
  );
